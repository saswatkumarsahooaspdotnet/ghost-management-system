<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="ghost_series.ForgotPassword" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        ...
        .loginBx {
            ...
            gap: 20px;
            width: 70%;
            transform: translateY(0); /* show heading immediately */
        ...
        .toggle-password {
            ...
            /* Hide only form fields until hover */
            .loginBx input,
            .loginBx .password-wrap,
            .loginBx .group,
            .loginBx .btn-login {
                opacity: 0;
            ...
            .box:hover .loginBx input,
            .box:hover .loginBx .password-wrap,
            .box:hover .loginBx .group,
            .box:hover .loginBx .btn-login {
                opacity: 1;
                transform: translateY(0);
            }
        ...
        <div class="login">
            ...
            <asp:Panel ID="pnlLogin" runat="server" CssClass="loginBx">
                ...
                <div class="password-wrap">
                    ...
                    <i class="fa-solid fa-eye toggle-password"
                        onclick="togglePassword('<%= txtRecheck.ClientID %>', this)"></i>
                </div>
                <asp:Button ID="btnReset" runat="server" Text="Reset Password" CssClass="btn-login" onclick="btnReset_Click"/>

                <div class="group">
                    <asp:HyperLink runat="server" NavigateUrl="AdminLogin.aspx">
                    Login
                    </asp:HyperLink>
