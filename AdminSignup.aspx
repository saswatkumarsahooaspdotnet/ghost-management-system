<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AdminSignup.aspx.cs" Inherits="ghost_series.AdminSignup" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        ...
        .loginBx {
            ...
            gap: 20px;
            width: 80%;
            transform: translateY(160px); /* push fully down */
            opacity: 1; /* hide form */
